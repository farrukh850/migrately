  ...
  return (
    <div className="pt-7">
      <div className="container">
        <div className="grid grid-cols-12 items-start justify-between">
          <div className="col-span-12 lg:col-span-8 mb-5 lg:mb-0">
           <div className="max-w-full lg:max-w-[487px]">
            <p className="text-base font-semibold leading-[130%] text-[#484E86] tracking-[-0.32px] mb-4.5 w-full lg:w-[60%]">Join our newsletter to stay on top of the latest advancements in AI immigration technology.</p>
        ...
        <div className="flex items-center justify-between mt-[77px]">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-3 max-w-full lg:max-w-[80%] mx-auto pb-10">
          <small className="text-sm text-[#484E86] text-center lg:text-start block">MIGRATELY ® is a registered trademark of Remtebase Inc.</small>
