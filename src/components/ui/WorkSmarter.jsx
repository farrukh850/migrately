    ...
    <div className="py-10 lg:py-[108px] bg-white border-b border-[#BABFD2]">
        <div className="container">
            <div className="flex flex-col gap-2">
                <small data-aos="fade-up" data-aos-delay="100" data-aos-duration="500" className="text-base leading-[130%] tracking-[-0.32px] text-[#232857]">Our Core Values for Lawyers</small>
                <h4 data-aos="fade-up" data-aos-delay="150" data-aos-duration="500" className="text-xl lg:text-[32px] leading-[130%] tracking-[-0.64px] text-[#232857] font-bold">Helping You Work Smarter, Not Harder</h4>
            </div>
            <div className="grid grid-cols-12 items-stretch gap-3 mt-12.5">
                <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="500" className="col-span-12 lg:col-span-4 p-10.5 rounded-xl border border-[#DFE2FF]">
                ...
                <div data-aos="fade-up" data-aos-delay="250" data-aos-duration="500" className="col-span-12 lg:col-span-4 p-10.5 rounded-xl border border-[#DFE2FF]">
                ...
                <div data-aos="fade-up" data-aos-delay="300" data-aos-duration="500" className="col-span-12 lg:col-span-4 p-10.5 rounded-xl border border-[#DFE2FF]">
