    ...
    <div className="pb-10 pt-25 lg:pb-[146px]">
        <div className="container">
            ...
            <div className="grid grid-cols-12 items-stretch min-h-[497px] h-full mt-10.5 shadow-[0px_30.503px_40.371px_18.84px_rgba(62,82,198,0.07)] rounded-xl">
                <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="500" className="col-span-12 lg:col-span-6 flex flex-col p-5 lg:py-22 lg:pl-22 lg:pr-15">
                ...
                <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="500" className="col-span-12 lg:col-span-6 bg-[rgba(62,82,198,0.07)] lg:pl-[79px] lg:pt-[47px] lg:pr-4 p-5">
