...
function Banner() {
  return (
    <div className="relative">
        ...
        <h1 data-aos="fade-up" data-aos-delay="100" data-aos-duration="500" className="text-3xl lg:text-5xl leading-[150%] tracking-[-2%] text-[#232857] mb-2">Cut Case Preparation Time for O1, EB‑1A & EB2-NIW by <b className="font-black">90%</b> Using AI</h1>  
        <p data-aos="fade-up" data-aos-delay="200" data-aos-duration="500" className="text-lg leading-[140%] tracking-[-2%] text-[#232857]">Generate AI draft cases in minutes, streamline document collection, and manage clients effortlessly with Migrately.</p>
        <div data-aos="fade-up" data-aos-delay="300" data-aos-duration="500" className="items-center gap-2.5 xl:flex hidden mt-6">
