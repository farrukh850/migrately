    ...
    <div className="py-10 lg:py-[117px] bg-[#F1F3FB]">
        <div className="container">
            ...
            <div className="grid grid-cols-12 items-stretch min-h-[497px] h-full mt-10.5 shadow-[0px_30.503px_40.371px_18.84px_rgba(62,82,198,0.07)] rounded-xl">
                <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="500" className="col-span-12 lg:col-span-6 flex flex-col p-5 lg:py-22 lg:pl-22 lg:pr-15 bg-[#fff]">
                ...
                <div data-aos="fade-up" data-aos-delay="150" data-aos-duration="500" className="col-span-12 lg:col-span-6 bg-[#F3F5FC] relative flex items-end justify-center">
            ...
            <div className="grid grid-cols-12 items-stretch min-h-[497px] h-full mt-10.5 shadow-[0px_30.503px_40.371px_18.84px_rgba(62,82,198,0.07)] rounded-xl">
                <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="500" className="col-span-12 lg:col-span-6 bg-[#F3F5FC] relative flex items-end justify-center order-2 lg:order-1">
                ...
                <div data-aos="fade-up" data-aos-delay="250" data-aos-duration="500" className="col-span-12 lg:col-span-6 flex flex-col p-5 lg:py-22 lg:pl-22 lg:pr-15 bg-[#fff] order-1 lg:order-2">
            ...
            <div className="grid grid-cols-12 items-stretch min-h-[497px] h-full mt-10.5 shadow-[0px_30.503px_40.371px_18.84px_rgba(62,82,198,0.07)] rounded-xl">
                <div data-aos="fade-up" data-aos-delay="300" data-aos-duration="500" className="col-span-12 lg:col-span-6 flex flex-col p-5 lg:py-22 lg:pl-22 lg:pr-15 bg-[#fff]">
                ...
                <div data-aos="fade-up" data-aos-delay="350" data-aos-duration="500" className="col-span-12 lg:col-span-6 bg-[#F3F5FC] relative flex items-end justify-center">
